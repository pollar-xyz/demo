...
export const en = {
  ...
  home: {
    ...
    descs: {
      ...
      borrow: "Use collateral to borrow assets through Jupiter Lend.",
...
export const es: Dictionary = {
  ...
  home: {
    ...
    descs: {
      ...
      borrow: "Usa colateral para pedir activos prestados mediante Jupiter Lend.",
...
export const pt: Dictionary = {
  ...
  home: {
    ...
    descs: {
      ...
      borrow: "Use garantias para tomar ativos emprestados pelo Jupiter Lend.",
