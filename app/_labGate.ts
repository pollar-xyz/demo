// Runtime gates for the still-in-testing "lab" integrations. Each group has its
...
// `?<param>=<passcode>` unlocks that one group: the passcode is validated
...
//
//   group key        URL param   cookie              env var (server-only)
//   ───────────────  ──────────  ──────────────────  ─────────────────────
...
// Per-group unlock state, keyed by nav group key.
